...
/// @nodoc
class _$UnionGenericTearOff {
  const _$UnionGenericTearOff();
...
/// @nodoc
const $UnionGeneric = _$UnionGenericTearOff();

/// @nodoc
mixin _$UnionGeneric<T> {
  @optionalTypeArgs
...
/// @nodoc
abstract class $UnionGenericCopyWith<T, $Res> {
  factory $UnionGenericCopyWith(
          UnionGeneric<T> value, $Res Function(UnionGeneric<T>) then) =
      _$UnionGenericCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$UnionGenericCopyWithImpl<T, $Res>
    implements $UnionGenericCopyWith<T, $Res> {
  _$UnionGenericCopyWithImpl(this._value, this._then);

  final UnionGeneric<T> _value;
  // ignore: unused_field
  final $Res Function(UnionGeneric<T>) _then;
}
...
/// @nodoc
class _$DataCopyWithImpl<T, $Res> extends _$UnionGenericCopyWithImpl<T, $Res>
...
class _$Data<T> implements Data<T> {
  ...
  @override
  String toString() {
    return 'UnionGeneric<$T>(value: $value)';
  }
...
abstract class Data<T> implements UnionGeneric<T> {
...
/// @nodoc
class _$LoadingCopyWithImpl<T, $Res> extends _$UnionGenericCopyWithImpl<T, $Res>
...
abstract class Loading<T> implements UnionGeneric<T> {
...
class _$ErrorDetailsCopyWithImpl<T, $Res>
    extends _$UnionGenericCopyWithImpl<T, $Res>
...
class _$ErrorDetails<T> implements ErrorDetails<T> {
  ...
  @override
  String toString() {
    return 'UnionGeneric<$T>.error(message: $message)';
  }
...
abstract class ErrorDetails<T> implements UnionGeneric<T> {
